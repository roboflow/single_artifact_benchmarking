...
class ProfilerBase:
    """Base class for profilers with shared statistics and timing storage."""
...
class CPUProfiler(ProfilerBase):
    """CPU profiler using high-resolution wall-clock timing."""

    @contextmanager
    def profile(self):
        """Synchronous profiling for CPU operations."""
