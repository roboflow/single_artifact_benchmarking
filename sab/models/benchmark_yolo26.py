...
class YOLOv26ONNXInference(ONNXInference):
...
class YOLOv26TRTInference(TRTInference):
...
def main(image_dir: str, annotations_file_path: str, buffer_time: float = 0.0, output_file_name: str = "yolov26_results.json"):
    # ONNX graphs generated with:
    # yolo export model=yolo26n.pt format=onnx
    # ultralytics version: 8.4.0
    # NOTE: this is the e2e model, without NMS, which significantly simplifies benchmarking and reduces inference time
    requests = [
        ArtifactBenchmarkRequest(
            onnx_path="yolo26n.onnx",
            inference_class=YOLOv26TRTInference,
            needs_fp16=True,
